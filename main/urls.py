...
urlpatterns = [path('', views.main, name="main"),
               ...
               path('inventar_AZ_cat/<int:category_id>', views.inventar_AZ_cat, name='inventar_AZ_cat'),
               path('inventar_ZA-cat/<int:category_id>', views.inventar_ZA_cat, name='inventar_ZA_cat'),
               path('inventar_price-cat/<int:category_id>', views.inventar_price_cat, name='inventar_price_cat'),
               path('inventar_reprice-cat/<int:category_id>', views.inventar_reprice_cat, name='inventar_reprice_cat'),
